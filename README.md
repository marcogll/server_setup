...
- **🌐 Connectivity:** ZeroTier One (Opcional).

## 📥 Instalación Rápida (One-Liner)

Copia y pega el siguiente comando en tu terminal. Este comando instala las dependencias necesarias (curl, git) y ejecuta el asistente automáticamente:
